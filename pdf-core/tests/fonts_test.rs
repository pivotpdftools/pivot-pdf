...
fn helvetica_bold_space_width() {
    assert_eq!(
        FontMetrics::char_width(BuiltinFont::HelveticaBold, ' ',),
        278,
    );
}
...
fn helvetica_uppercase_a() {
    assert_eq!(FontMetrics::char_width(BuiltinFont::Helvetica, 'A'), 667,);
}
...
fn unmapped_char_returns_default() {
    ...
    assert_eq!(
        FontMetrics::char_width(BuiltinFont::Helvetica, '\u{00E9}',),
        278,
    );
    // Control character
...
fn pdf_base_name_returns_correct_names() {
    ...
    assert_eq!(BuiltinFont::TimesRoman.pdf_base_name(), "Times-Roman",);
    assert_eq!(BuiltinFont::Courier.pdf_base_name(), "Courier",);
    assert_eq!(BuiltinFont::Symbol.pdf_base_name(), "Symbol",);
    assert_eq!(BuiltinFont::ZapfDingbats.pdf_base_name(), "ZapfDingbats",);
}
...
fn times_roman_widths() {
    // Times-Roman 'A' = 722
    assert_eq!(FontMetrics::char_width(BuiltinFont::TimesRoman, 'A',), 722,);
    // Times-Roman space = 250
    assert_eq!(FontMetrics::char_width(BuiltinFont::TimesRoman, ' ',), 250,);
}

#[test]
fn times_bold_widths() {
    // Times-Bold 'A' = 722
    assert_eq!(FontMetrics::char_width(BuiltinFont::TimesBold, 'A',), 722,);
    // Times-Bold 'a' = 500
    assert_eq!(FontMetrics::char_width(BuiltinFont::TimesBold, 'a',), 500,);
}

#[test]
fn courier_uniform_width() {
    // All Courier variants should return 600 for any character
    assert_eq!(FontMetrics::char_width(BuiltinFont::Courier, 'A'), 600,);
    assert_eq!(FontMetrics::char_width(BuiltinFont::Courier, ' '), 600,);
    assert_eq!(FontMetrics::char_width(BuiltinFont::CourierBold, 'W',), 600,);
    assert_eq!(
        FontMetrics::char_width(BuiltinFont::CourierOblique, 'i',),
        600,
    );
    // Non-ASCII also returns 600 for Courier
    assert_eq!(
        FontMetrics::char_width(BuiltinFont::Courier, '\u{00E9}',),
        600,
    );
}
...
fn helvetica_oblique_shares_widths() {
    ...
    assert_eq!(
        FontMetrics::char_width(BuiltinFont::HelveticaOblique, 'A',),
        FontMetrics::char_width(BuiltinFont::Helvetica, 'A',),
    );
    assert_eq!(
        FontMetrics::char_width(BuiltinFont::HelveticaBoldOblique, 'A',),
        FontMetrics::char_width(BuiltinFont::HelveticaBold, 'A',),
    );
}
...
fn symbol_uses_default_width() {
    assert_eq!(FontMetrics::char_width(BuiltinFont::Symbol, 'A'), 278,);
    assert_eq!(
        FontMetrics::char_width(BuiltinFont::ZapfDingbats, 'A',),
        278,
    );
}
